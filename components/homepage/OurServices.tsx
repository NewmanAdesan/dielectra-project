  ...
  return (
    <section className='mt-52 xs:mt-40'>
      <div className='p-5 md:px-10 max-w-7xl mx-auto'>
        ...
        <Service src='/homepage/service2.png' alt='Service 2 - Operation and Maintenance' index='02' title='Engineering and Construction' desc='We carry out preventive, predictive and corrective maintenance on your electrical network and its associated equipment.' changePosition={true} last={false}/>
        <Service src='/homepage/service3.png' alt='Service 3 - Consultation' index='03' title='Consultation' desc='We specialize in providing comprehensive electrical consultation services tailored to meet the unique needs of our clients.' changePosition={false} last={true}/>
